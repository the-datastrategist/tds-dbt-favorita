...
| [Monitoring, alerts, and SLOs](monitoring_and_slos.md) | In progress | 60% | Platform roadmap → P1 monitoring | Accuracy, mode-aware source health, and scheduled pipeline health are implemented; remaining work covers broader SLOs, alert delivery, drift, calibration, and cost |
