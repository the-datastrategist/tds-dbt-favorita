...
| [Monitoring, alerts, and SLOs](monitoring_and_slos.md) | In progress | 95% | Platform roadmap → P1 monitoring | Live-accepted source, pipeline, publication-freshness, prediction-coverage, feature-completeness, and realized-calibration signals plus an opt-in hosted evaluator and Cloud Monitoring routing are implemented; production activation, drift, and cost remain |
