...
| [Scheduled forecast publication pipeline](scheduled_forecast_publication_pipeline.md) | Proposed | 10% | Cross-spec operational integration | Connect champion scoring, routing, calibration, reconciliation, validation, draft visibility, and publication through one retry-safe scheduled contract |
