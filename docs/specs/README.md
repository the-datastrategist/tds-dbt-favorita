...
Status reviewed **2026-07-24**. The completion figures are implementation estimates, while
...
| [Forecasting methods, horizons, cold start, and intermittent demand](forecasting_methods.md) | In progress | 90% | `demand_forecasting_platform_recommendations.md` → P0/P1 methods | Horizon-aware models, intermittent-demand baselines, calibration, cold-start routing, and scheduled-stage integration are implemented; live end-to-end publication acceptance remains |
| [Hierarchical reconciliation](hierarchical_reconciliation.md) | In progress | 85% | `demand_forecasting_platform_recommendations.md` → P1 reconciliation | Configurable hierarchies, bottom-up/top-down/middle-out/MinT methods, persistence, tests, and scheduled-stage integration are implemented; live hierarchical acceptance remains |
...
| [Forecast operations](forecast_operations.md) | In progress | 65% | `demand_forecasting_platform_recommendations.md` → P1/P2 operations | Append-only operation tables, staging contracts, atomic draft creation, and gated idempotent publication are implemented; planner overrides, revision/rollback commands, and delivery remain |
