...
current implementation is approximately **87% complete**. Excluding open-source productization,
...
| [Open-source forecasting platform UI](open_source_frontend_ui.md) | In progress | 35% | Platform roadmap → P2/P3 frontend | React/Vite shell, public deployment, platform overview, canonical Forecast Explorer, model views, and its typed production read-only forecast API are implemented; authenticated production activation, experiment/error analysis, and operational views remain |
