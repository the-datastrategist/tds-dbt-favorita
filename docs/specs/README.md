...
| [General-purpose demand forecasting platform](platform_generalization.md) | In progress | 40% | Separate platform-generalization workstream | Canonical adapters and identity are live accepted across rolling-origin scoring, publication, persistence, reconciliation evidence, retrieval, realized monitoring, and SLO models; remaining model families, hierarchy adapters, period abstraction, and extension APIs remain |
