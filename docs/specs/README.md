...
| [General-purpose demand forecasting platform](platform_generalization.md) | In progress | 34% | Separate platform-generalization workstream | Canonical adapters and identity now span rolling-origin scoring, publication, persistence, reconciliation evidence, retrieval, and realized monitoring; remaining model families, hierarchy adapters, period abstraction, and extension APIs remain |
