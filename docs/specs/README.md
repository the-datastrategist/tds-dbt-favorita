...
| [General-purpose demand forecasting platform](platform_generalization.md) | In progress | 60% | Separate platform-generalization workstream | Canonical adapters and identity are live accepted across core consumers; all model-family configs use canonical roles, configured hierarchy materialization reads canonical identity, and shared day/week/month period arithmetic covers publication and backtesting; live retraining, remaining temporal consumers, and extension APIs remain |
