...
| [General-purpose demand forecasting platform](platform_generalization.md) | In progress | 24% | Separate platform-generalization workstream | Typed deployment/resource catalog, canonical Favorita adapters, and canonical rolling-origin store scoring are implemented; remaining model families, publication/reconciliation migration, period abstraction, and extension APIs remain |
