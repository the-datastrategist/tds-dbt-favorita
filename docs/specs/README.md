...
| [Open-source forecasting platform UI](open_source_frontend_ui.md) | In progress | 20% | Platform roadmap → P2/P3 frontend | React/Vite application shell, approved demo-data boundary, platform overview, model leaderboard/detail views, accessible tests, logo, and self-hosted fonts are implemented; forecast exploration, experiment/error analysis, operational views, and the production API remain |
