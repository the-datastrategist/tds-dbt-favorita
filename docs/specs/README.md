...
| [General-purpose demand forecasting platform](platform_generalization.md) | In progress | 68% | Separate platform-generalization workstream | Canonical adapters and identity are live accepted across core consumers; model configs, configured hierarchy materialization, shared day/week/month arithmetic, and versioned extension contracts are implemented; live family retraining, remaining temporal consumers, and production extension wiring remain |
