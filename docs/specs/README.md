...
| [Open-source forecasting platform UI](open_source_frontend_ui.md) | In progress | 85% | Platform roadmap → P2/P3 frontend | Overview, model, forecast, experiment, error-analysis, and operations workflows plus typed production APIs and IAP roles are implemented; live IAP/warehouse/browser acceptance and pipeline/hierarchy views remain |
