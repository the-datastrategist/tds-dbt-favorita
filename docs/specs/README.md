...
| [Monitoring, alerts, and SLOs](monitoring_and_slos.md) | In progress | 80% | Platform roadmap → P1 monitoring | Live-accepted source, pipeline, publication-freshness, and prediction-coverage signals plus versioned alert contracts and opt-in Terraform policy are implemented; hosted delivery, feature completeness, drift, calibration, and cost remain |
