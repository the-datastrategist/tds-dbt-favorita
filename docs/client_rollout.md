...
| Workload Identity Federation ✅ shipped | Repository-scoped GitHub OIDC + keyless CI plan; bootstrap per client | [specs/workload_identity_federation.md](specs/workload_identity_federation.md) |
