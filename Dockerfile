...
RUN npm ci
COPY frontend/ ./
ARG VITE_DBT_DOCS_URL
ARG VITE_PREFECT_URL
ARG VITE_MLFLOW_URL
ARG VITE_RUNBOOK_URL
RUN VITE_DATA_MODE=api VITE_API_BASE_URL= \
    VITE_DBT_DOCS_URL="$VITE_DBT_DOCS_URL" \
    VITE_PREFECT_URL="$VITE_PREFECT_URL" \
